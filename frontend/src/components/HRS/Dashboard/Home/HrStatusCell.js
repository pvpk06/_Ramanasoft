...
const HrStatusCell = ({ value, row, updateStatus, isEditing }) => {
  console.log(value)
    const statusInfo={'jd-received':'JD Received','profiles-sent':'Profiles sent','drive-scheduled':'Drive Scheduled','drive-done':'Drive Done','offer-received':'Offer Recieved', 'not-interested':"Not Interested"} 
