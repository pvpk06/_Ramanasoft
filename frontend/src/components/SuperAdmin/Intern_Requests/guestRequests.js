...
//     { headerName: "Phone", field: "mobileno", sortable: true, filter: true },
...
//     { headerName: "Mode of Training", field: "modeOfTraining", sortable: true, filter: true },
//     { headerName: "Mega Drive Status", field: "megadriveStatus", sortable: true, filter: true },
//     {
//       headerName: "Actions",
//       field: "actions",
...
//     handleSelectCandidate(selectedRows);
//   };
...
//           </Table> */}
//           <CandidatesTable filteredCandidates={filteredCandidates} selectedCandidates={selectedCandidates} handleSelectCandidate={handleSelectCandidate} handleSelectAllCandidates={handleSelectAllCandidates} handleAccept={handleAccept} handleReject={handleReject}/>
//           {(filteredCandidates.length===0) &&<p style={{textAlign:'center'}}>No registration requests</p>}
//         </div>
//         {selectedCandidates.length > 0 && 
//           <div className="d-flex justify-content-end">
